...
• Oft ist der Text in der URL leicht verändert oder enthält Buchstabendreher: Bsp. «https://password.e h tz.ch»
...
Handelt es sich um eine verschlüsselte Verbindung (https)? Ist das SSL-Zertifikat dieser Webseite ein gültiges Zertifikat?

## Unsicher? Im Zweifelsfall lieber nachfragen

Senden Sie verdächtige E-Mails als Anhang an und löschen Sie sie danach aus Ihrer Mailbox. Im Zweifelsfall wenden Sie sich an den ID Service Desk .
