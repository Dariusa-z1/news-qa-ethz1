...
Das bisherige nethz-Admin-Tool (neuer Name: «Admin-Tool ohne IAM-Funktionalitäten» ist unter der URL www.idn.ethz.ch zu erreichen. Es wird noch benutzt, zum Spamfilter einzustellen, MySQL-Datenbank anzufordern sowie Lync und andere Services zu aktivieren.

Die ETH Zürich betreibt ein Identity und Access Management (IAM)-System. Das System ermöglicht die Steuerung und Versorgung mit Daten der Directory Services LDAP, Active Directory und Switch AAI (ETH-Teil), die Vereinheitlichung der Verwaltung von Gruppen und Verteilern, die Verwaltung von multiplen Passwörtern und die Bereitstellung von Self-Service und Service Desk-Funktionen über eine Web Applikation. Das System wurde technisch erneuert und wird neue Funktionen u.a. im Bereich Auditing und Föderierung mit fremden IAM-Systemen anbieten.
