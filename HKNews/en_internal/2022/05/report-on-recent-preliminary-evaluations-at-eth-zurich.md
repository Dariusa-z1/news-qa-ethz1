...
The complete official statement by ETH Zurich, an extract from the independent expert report and an assessment by the ETH Board are available on the ETH Board's website (in Germany only).
