...
To ensure that these conversations are effective and fruitful, supervisors are encouraged to think about how they want to conduct these exchanges with their team. The Vice-Presidency for Personnel Development and Leadership has prepared a protected page workshop template lock that can be used as a guide.
...
• protected page Workshop template "Return to the office" lock
• Flexible working | ETH Zurich
• Return to the office & future of work | ETH Zurich
• Working from home| ETH Zürich
• Mobile working | ETH Zürich
