...
Or the latest example: instead of installing a yellow board with the new signage at Hönggerberg and waiting for feedback, the project was rolled out across the entire Hönggerberg campus (after a very long preparation period). As we all know, the reactions range from “the boards are ugly” to “the street names are too long”. ETH cannot and will not reverse the whole operation. It goes without saying that such reactions make future changes difficult, as they occasionally trigger fear of further failure.
