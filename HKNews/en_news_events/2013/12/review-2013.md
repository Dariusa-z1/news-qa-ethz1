...
ETH's researchers observed a gas giant planet forming in the disc around the young star HD 100546 (Graphic: eso)
...
Thanks to data exchange with a cloud computing platform, robots can learn from each other. (Photo: RoboEarth.org)
...
This novel High Concentration Photovoltaic Thermal can accommodate a 2,000-fold concentration of sunlight. (Bild: IBM Research Zurich)
...
ETH Zurich drives research and development of deep geothermal energy forward with a new professor. (Photo: Alain Bachellier / flickr.com)
...
Olivier Voinnet explains Max Rössler (right) how small interfering RNA molecules protect plants against viruses. (Photo: ETH Zurich)
...
Microscopic picture of a planctonic diatome. (Photo: Karine Leblanc, Marseilles)
...
A quenched galaxy (identified by a crosshair at the centre of the photo), observed during the Cosmos project. (Photo: NASA, ESA, ETH Zurich)
...
ETH researchers redesigned the diesel engine of a VW Golf to run on 90% natural gas (Photo: Tobias Ott / ETH Zurich).
...
A novel DNA test will give dealers and owners of pearl jewellery greater transparency regarding a pearl’s source. (Photo: Swiss Gemmological Institute SSEF)
...
Sensing Earth's magnetic field from space: ETH researchers venture to the frontier of science with the SWARM mission. (Graphic: ESA)
...
European bumblebees invaded the southern parts of South America at breathtaking speed. (Photo: Chris Würbel, flickr.com)
