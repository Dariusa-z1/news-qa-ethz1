# reimagining-climate-action-biodiversity-and-energy-supply-together
...
It is precisely these kinds of interfaces and conflicting goals that Switzerland will be confronted with in the coming years on the road towards climate neutrality. SPEED2ZERO, a joint initiative of the institutions within the ETH Domain, is investigating these interfaces. Together with researchers from the fields of biodiversity, landscape, energy and climate, we have assessed some of these trade-offs from a scientific perspective and summarised them in a white paper . 1
...
Of all renewables, hydropower plants have the greatest negative impact on biodiversity. Of the 15 planned hydropower projects, 13 are at existing reservoirs that would be expanded or, in one case, newly developed for energy purposes. The negative impact of these expansions is much smaller than for plants at new locations. Two projects are new reservoirs in places where there was previously a glacier tongue.

In my view, however, it would be wrong to reject new infrastructure just because it is not without consequences. We should be aware that the landscape will change anyway. Doing nothing does not mean that nature will not change. Progress on climate change mitigation is urgently needed.

In the current debate on the consequences of renewables, it can be emphasised from a scientific perspective that such plants are not the main cause of dwindling biodiversity. However, biodiversity as a crisis is just as real and life-threatening as climate change. We can only solve both together – and one key to this is renewable energies.

As a society, however, we cannot avoid asking ourselves the same uncomfortable questions in other areas of life. We should therefore discuss the main causes of biodiversity loss just as openly and find pragmatic compromises.

1 Concurrent challenges for Switzerland – interfaces in climate action, biodiversity conservation, energy security and landscape preservation. Whitepaper (2024) SPEED2ZERO

2 Trendwende Klima und Biodiversität (2022) Swiss Academy of Sciences (Report in German)
