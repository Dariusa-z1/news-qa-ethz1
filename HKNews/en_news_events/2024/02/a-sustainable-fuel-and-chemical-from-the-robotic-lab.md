...
- As a first demonstration project, researchers looked for better catalysts for the production of methanol.

- The new technology platform will also speed up the development of other catalysts.
...
“The Swiss Cat+ hub provides us with complex research infrastructure that we wouldn’t be able to operate ourselves with the groups in our laboratories,” explains Professor Christophe Copéret from the Department of Chemistry and Applied Biosciences at ETH Zurich. Research at universities is heavily dependent on doctoral students, but they stay only for a few years. Every time a doctoral student leaves, much of the expertise they have built up is lost. In contrast, Swiss Cat+ is a technology platform designed to work with permanently employed experts who are able to continuously develop their expertise and use the latest technologies to refine the infrastructure.

Initiated in 2019 by Copéret and Nicolai Kramer, a professor at EPFL, the Swiss Cat+ hub now provides researchers from universities and industry with state-of-the-art infrastructure at two locations in Zurich and Lausanne. These make it possible to design catalysts with the help of AI data analysis tools, then produce them immediately in automated high-throughput laboratories and test their effectiveness. Dozens of ETH projects are already using the two platforms.

Ramirez A, Lam E, Pacheco Gutierrez D, Hou Y, Tribukait H, Roch LM, Copéret C, Laveille P: Accelerated Exploration of Heterogenous CO2 Hydrogenation Catalyts by Bayesian-optimized High-throughput and Automated Experimentation. Chem Catalysis, 18. Januar 2024, doi: 10.1016/j.checat.2023.100888

Laveille P, Miéville P, Chatterjee S, Clerc E, Cousty JC, de Nanteuil F, Lam E, Mariano E, Ramirez A, Randrianarisoa U, Villat K, Copéret C, Cramer N: Swiss Cat+, a Data-driven Infrastructure for Accelerated Catalysts Discovery and Optimization. Chimia 2023, 77: 154, doi: 10.2533/chimia.2023.154
