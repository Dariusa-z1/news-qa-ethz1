# eth-software-to-become-standard-for-drones
...
The electronics group unveiled the platform, known as “Snapdragon Flight”, in October 2015. Integral to the platform is the PX4 software, the brainchild of Lorenz Meier, a doctoral student in computer science at ETH Zurich.

## A modular structure is the key to success

This program is likely to become the gold standard for drone flight controllers in the next few years. “PX4 has the potential to become the backbone of the rapidly growing drone industry. The PX4 software will be to drones what Android is to many smartphones,” says Meier, who is working on his doctorate in the Computer Vision and Geometry Group led by Professor Marc Pollefeys.
...
## A product of the ETH ecosystem
...
## A side project evolved into a major undertaking
...
With PX4, Meier and his colleagues have made a major breakthrough: they have set a standard. In today's world this is an almost miraculous achievement, akin perhaps to UC Berkeley’s success 30 years ago with Berkeley Software Distribution – the basis of Unix systems.

## Donations paved the way for further development
