...
An international team of European seismologists, geologists, and engineers, with leading support of members from the Swiss Seismological Service and the Group of Seismology and Geodynamics at ETH Zurich has; therefore, revised the earthquake hazard model that has existed since 2013 and created a first earthquake risk model for the whole of Europe.
...
Furthermore, on the map in the European model, the core zone in Geneva lies in a single cell, whereas in Zurich, which has similar conditions, it is spread across three cells. From a purely visual point of view, therefore, the risk appears greater for Geneva than for Zurich, for example.
