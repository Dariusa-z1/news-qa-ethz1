...
## Now with the participation of Computer Science
...
First held in 2012, ETH Zurich’s Paul Bernays Lectures are an annual, three-part honorary lecture series dedicated to the philosophy of the exact sciences.

To date, the Departments of Mathematics and Physics have participated in the honorary lecture series, which is organised by the Department of Humanities, Social and Political Sciences. Many of the topics addressed in this context are also relevant to computer science, however, which is why the Department of Computer Science is now also participating in the Paul Bernays Lectures this year.

## References

Prof. Scott Joel Aaronson, University of Texas at Austin. Introduction by Prof. Renato Renner, Department of Physics, ETH Zurich. Monday, 2 September 2019, 5 pm, Auditorium E7, ETH Main Building

Further information about the lectures for a specialised audience can be found at: www.ethz.ch/bernays .

Shtetl-Optimized. The Blog of Scott Aaronson. www.scottaaronson.com/blog

Aaronson, S. Read the fine print, in: Nature Physics, 2015, Vol. 11(4), pp. 291–293, DOI: 10.1038/nphys3272

Aaronson, S. Quantum Computing since Democritus. Cambridge: Cambridge University Press, 2013. DOI: 10.1017/CBO9780511979309
