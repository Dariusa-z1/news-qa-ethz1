...
The bats’ preference for the “artificial crag” does, however, have a downside: on mild nights, the bats manage to make their way into the building through open skylights – but then they often have a hard time getting out again. ETH mem­bers later find the animals weak, thirsty and listless. Touching them with bare hands is out of the question, as just a single bite could spread rabies. The best course of action is to call building services or the specialists at the Swiss bat protection foundation.
