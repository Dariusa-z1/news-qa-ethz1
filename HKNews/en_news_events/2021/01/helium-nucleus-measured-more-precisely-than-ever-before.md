# helium-nucleus-measured-more-precisely-than-ever-before
...
In the experiment, the laser frequency is varied until a large number of X-ray signals arrive. Physicists then speak of the so-called resonance frequency. With its help, then, the difference between the two energetic states of the muon in the atom can be determined. According to theory, the measured energy difference depends on how large the atomic nucleus is. Hence, using the theoretical equation, the radius can be determined from the measured resonance. The necessary data analysis was carried out by Randolf Pohl's group at the Johannes Gutenberg University in Mainz.
...
Detailed media release of the Paul Scherrer Institute
