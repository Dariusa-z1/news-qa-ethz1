# globe-andere-wege-fuer-das-abwasser
...
Stofftrennung an der Quelle (No-Mix): Werden Ausscheidungen und Wasser gar nicht erst vermischt, lassen sie sich viel einfacher aufbereiten und wiederverwenden. Rückgewinnung von Ressourcen : Aus Urin und Fäkalien lassen sich Nährstoffe wie Stickstoff oder Phosphor gewinnen. Das als Grauwasser bezeichnete Abwasser aus Küche, Bädern oder Waschmaschinen ist nur leicht verschmutzt und wird mehrfach aufbereitet und wiederverwendet. Wärmeenergie wird zurückgewonnen. Werden die Nährstoffe als Dünger auf die Felder gebracht, schliessen sich Nährstoffkreisläufe, was die Umwelt entlastet und die Importabhängigkeit von mineralischen Dünger senkt. Dezentralisierung will den aufwendigen Wassertransport in zentral organisierten Leitungsnetzen ersetzen und bedingt, dass die Abwässer und Abfälle so nah wie möglich an der Quelle aufbereitet werden.
...
Ganze Ausgabe lesen (PDF, 2.8 MB)
