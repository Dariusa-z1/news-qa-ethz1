# ein-pionier-des-schweizer-internets-tritt-ab
...
Switch betreibt die Hochschulnetzwerke der Schweizer Hochschulen und registriert sämtliche .ch- und .li-Domain-Namen. Bis Ende 2014 hat Switch die Domains auch selbst verkauft, doch diese Aufgabe wurde jetzt an verschiedene Internetdienstleister übertragen.

«Ende der Achtzigerjahre hat noch niemand an eine kommerzielle Nutzung des Internet gedacht», resümiert er. Damals ging es in erster Linie darum, den Austausch per E-Mail zwischen den Hochschulen und den Zugang der Forscher zu Hochleistungsrechnern zu ermöglichen.

Im Gespräch mit Bernhard Plattner zeigt sich schnell, dass es ihm um die Chancen und das Potenzial des Internets geht. Er will wissen, wie dieses «Netz der Netzwerke» funktioniert und wie es noch besser werden kann. Dabei ist ihm die Anwendbarkeit, der Nutzen, sehr wichtig. Das hat Plattner auch all seinen Doktoranden mit auf den Weg gegeben. «Ihre Forschungsarbeiten sollten drei Anforderungen erfüllen: Erstens sollte sie etwas sein, was noch niemand vorher gemacht hat. Zweitens sollten ihre Lösungen besser sein als vergleichbare, frühere Ansätze. Und drittens sollten die Resultate nützlich sein.»

Sein Engagement zur Verbreitung des Internets in der Schweiz und vor allem an den Hochschulen war vielseitig. Neben international beachteten Publikationen trugen Programme wie ETH World, das er von 2002 bis 2005 leitete, dazu bei. Im Rahmen von ETH World wurde unter anderem an neuen Lehrmethoden und an Ansätzen für die Zusammenarbeit bei räumlicher Trennung – «virtual presence» – gearbeitet. Das Projekt «Neptun» ermöglicht es bis heute Studierenden und Mitarbeitenden Laptops günstig zu erwerben. Wobei die Dienste von externe Seite Neptun seit 2007 allen Schweizer Hochschulen zur Verfügung stehen.

Entwickelt wurde auch ein Internettelefonie-Dienst für ETH-Angehörige, der jedoch Ende 2013 eingestellt wurde. Plattner selbst zählt zu den Vorreitern im Bereich Internettelefonie. «Ich habe schon seit 2002 kein Festnetz mehr und telefoniere seitdem nur übers Internet.» Einzig von sozialen Netzwerken hält er sich fern. Als Hauptgrund nennt er den Faktor Zeit, meint aber, dass es auch eine Generationsfrage sein könnte.

Für die Zukunft erwartet Bernhard Plattner ein immer stärkeres Verschmelzen der virtuellen mit der realen Welt. Dazu gehört für ihn zum Beispiel, dass ein Auto nach einem Unfall selbständig Polizei und Rettungswagen alarmiert oder dass ein Smartphone nach einem Lawinenniedergang einen Notruf absetzt – so wie es die vom ETH Spin-Off « externe Seite Uepaa Swiss Alpine Technology » entwickelte App kann.
...
## Jubiläumsfeier am 5. Juni 2015

Am Freitag, 5. Juni, lädt das Institut für Technische Informatik und Kommunikationsnetze (TIK) zu einer Jubiläumsfeier ein. Um 12.30 Uhr beginnt die Veranstaltung mit einen Lunch, an den sich ab 14 Uhr verschiedene Vorträge anschliessen. Den Abschluss macht ein Get-together der Angehörigen und der Alumni des Instituts ab 19 Uhr im Zunftshaus zur Saffran.

Weitere Informationen zum Programm unter tikanniversary.ethz.ch .
