# fresh-herbs-from-factory-halls-and-bunkers.html
...
Zahran, who graduated with a Master’s degree in architecture from ETH two years ago, is one of the founders of YASAI. Yasai means vegetables in Japanese and indicates the direction this new type of agriculture is set to take. With the future technology of vertical farming, crops will no longer be grown outdoors in the fields, but indoors in high-rise buildings or high-ceilinged halls: vegetables, lettuces and herbs will grow stacked on top of each other on multiple rows of shelves. What’s special about this method is that the plants thrive not in soil, but in nutrient-rich water. The room’s climate – light, temperature, irrigation – is regulated automatically, with artificial intelligence helping to maintain the ideal conditions.

## More yield, less consumption

With all the advantages it brings, this new way of growing vegetables has a bright future. For one, production under artificial conditions is much more resource‑efficient than farming in the field. “Over the same area, our yield is 15 times greater while using 95 percent less water,” Zahran explains. In addition, no pesticides are needed, and because cultivation takes place in populated areas, there are no costs for transport that damages the environment. “Our products are even better than organic because we produce more sustainably. We make more from fewer resources, and can guarantee no pesticides,” Zahran says.
