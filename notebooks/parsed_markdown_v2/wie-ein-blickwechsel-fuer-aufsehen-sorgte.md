# wie-ein-blickwechsel-fuer-aufsehen-sorgte.html
...
Zurück zu den seismischen Wellen. «Wir können nicht 200 Kilometer tief in die Erde zu einem Bebenherd schauen», sagt die Mathematikerin. Mit Messungen und physikalischen Modellen lassen sich aber seismische Daten simulieren. Die simulierten Erdbebenwellen werden mit den real gemessenen verglichen, und man versucht, sie anzugleichen und den Unterschied zwischen den beiden zu minimieren. «Zur Lösung des Problems habe ich die Art und Weise geändert, wie man die Differenz zwischen den Wellen misst», erklärt Yang: «Ich stelle mir vor, die gemessenen Wellen seien ein Sandhaufen. Ich simuliere einen zweiten Sandhaufen und versuche, den optimalen Weg zu finden, um sie anzugleichen.» Mathematisch formuliert benutzt Yang eine andere Metrik zur Messung der Wellen, nämlich diejenige, die sich aus der Theorie des optimalen Transports ergibt.
...
Mathematische Arbeit kann frustrierend sein. «90 Prozent der Zeit steckt man fest – das ist kein gutes Gefühl», sagt Yang. Um auf neue Gedanken zu kommen, geht sie an die frische Luft und läuft. Nach einigen Halbmarathons ist sie dieses Jahr in Zürich erstmals über die gesamte Marathon-Distanz gelaufen. Sie wandert zudem gerne in den Bergen. «Das ist hier so praktisch, wie eine Schweizerin nehme ich einfach den Zug», sagt sie. Auch Unterrichten sei eine gute Ablenkung, denn dabei spreche sie über Dinge, die sie kenne. «Das stärkt das Selbstvertrauen.» Im Juli übernimmt sie nun an der Cornell-Universität in den USA eine Tenure-Track-Professur, die auch Lehrtätigkeit beinhaltet.

Der Umzug in die USA habe auch private Gründe: «Ich werde heiraten und mein zukünftiger Ehemann ist Professor in Cornell.» Im Vergleich zu Zürich sei die Stadt klein, aber ebenfalls hübsch mit vielen Seen in der Umgebung – ein idealer Ort fürs Familienleben. «Die Stelle an der ETH gab mir eine grossartige Gelegenheit, Beziehungen aufzubauen und mit Menschen aus verschiedenen Teilen Europas zusammenzuarbeiten», sagt die Mathematikerin: «In Zukunft kann ich diese Kollaborationen fortführen.»
...
Engquist, B, Ren, K, Yang, Y. The quadratic Wasserstein metric for inverse data matching. Inverse Problems 36 (2020) 055001. DOI: externe Seite https://doi.org/10.1088/1361-6420/ab7e04

Yang, Y, Engquist, B, Sun, J, Hamfeldt B F. Application of optimal transport and the quadratic Wasserstein metric to full-waveform inversion. Geophysics 83 (2018) 1. DOI: externe Seite https://doi.org/10.1190/geo2016-0663.1

Engquist, B, Froese, B D, Yang, Y. Optimal transport for seismic full waveform inversion. Communications in Mathematical Sciences 14 (2016) 8 DOI: externe Seite https://dx.doi.org/10.4310/CMS.2016.v14.n8.a9
