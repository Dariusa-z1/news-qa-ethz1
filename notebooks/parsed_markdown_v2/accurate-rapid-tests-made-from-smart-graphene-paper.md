# accurate-rapid-tests-made-from-smart-graphene-paper.html
...
- A team of ETH researchers has now found a way to make rapid tests much more sensitive, faster and more accurate using a test strip paper made of graphene.

- The ETH researchers have not only scientifically proven their rapid test method, but have also simplified the production of the analytical paper strips to such an extent that a usable product can be achieved in practice.
