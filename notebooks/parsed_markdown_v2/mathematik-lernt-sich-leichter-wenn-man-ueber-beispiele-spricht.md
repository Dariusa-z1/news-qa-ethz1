# mathematik-lernt-sich-leichter-wenn-man-ueber-beispiele-spricht.html
...
Mit diesen Fragen befassen sich Anne Deiglmayr und Lennart Schalk. Die beiden Dozierenden forschen an der Professur für Lehr- und Lernforschung von Elsbeth Stern an der ETH Zürich. Erste Ergebnisse ihres aktuellen Projektes haben sie an Konferenzen vorgestellt (zum Beispiel am externe Seite Jahrestreffen 2013 der Cognitive Science Society ). Ihre Ergebnisse beruhen auf Experimenten, die sie mit Studierenden der ETH Zürich, der Universität Zürich und der Pädagogischen Hochschule Zürich im Entscheidungslabor der ETH durchführen.

In den Experimenten bilden jeweils drei Studierende ein Team. In einer ersten Phase lernen sie allein am Computer. Dazu erhalten sie Textaufgaben zu Grundlagen der Wahrscheinlichkeitsrechnung, wobei diese Aufgaben vom selben Typ sind, aber aus unterschiedlichen Anwendungsgebieten stammen. Anschliessend tauschen sie sich via Chatforum aus und bearbeiten die Aufgaben gemeinsam.
...
Auch in Lehr- und Lernsituation werden ähnliche Situationen geschaffen, indem man Ressourcen und Informationen zwischen den Mitgliedern einer Gruppe verteilt. Diese Art von Lernsituation bezeichnet man in der Psychologie auch als «Gruppenpuzzle». Bei einem klassischen Gruppenpuzzle erlernt zunächst jeder allein ein Unterthema, für das er in der Gruppe ein Experte ist.
...
Die zugrunde liegenden mathematischen Prinzipien lernt man in der Regel bereits in der Mittelschule, manche Studierende haben sie aber bis zum Studium wieder vergessen. Für ihre Studie wählten die Forschenden nur Teilnehmende aus, die eine Auffrischung benötigten.

## Selber erkennen, was grundsätzlich gilt

Durch das Vergleichen und Kontrastieren vorgegebener Beispielaufgaben, lernt der Proband die zugrunde liegenden mathematischen Prinzipien. Indem die Probanden ihre Aufgaben besprechen und miteinander kooperieren, erkennen sie, dass die Prinzipien in verschiedenen Anwendungsgebieten gelten, und wie sie sie selbständig auf weitere anwenden können: «Diese Fähigkeit zum Wissenstransfer ist wichtig», sagt Lennart Schalk, «denn keine Schule kann auf alle möglichen Anwendungen eines wissenschaftlich-mathematischen Prinzips oder Konzepts vorbereiten.»
