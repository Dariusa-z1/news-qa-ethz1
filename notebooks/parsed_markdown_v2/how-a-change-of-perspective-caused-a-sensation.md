# how-a-change-of-perspective-caused-a-sensation.html
...
Back to seismic waves. “We can’t look at the focus of an earthquake 200 kilometres below ground,” Yang says. However, seismic data can be simulated with measurements and physical models. The simulated earthquake waves are compared with the real measured ones, and attempts are made to match them and minimise the differences between the two. “To solve the problem, I changed the way we measure these differences,” Yang explains. “I imagine the measured waves are a pile of sand. Then I simulate a second pile of sand and try to find the optimal way to match them up.” In mathematical terms, Yang uses a different metric to measure the waves, namely the one that arises from the theory of optimal transport.
...
Mathematical work can be frustrating. “Ninety percent of the time, you’re stuck; it’s not a good feeling,” Yang says. To clear the cobwebs, she goes out running in the fresh air. After completing a few half-marathons, she ran the full marathon distance for the first time this year in Zurich. She also enjoys hiking in the mountains. “It’s so convenient here – I just take the train like the Swiss do,” she says. Teaching is also a good distraction, she says, because it involves talking about things she knows: “It’s a confidence booster.” In July, she’ll be starting a tenure-track professorship at Cornell University in the US, which includes teaching.

The move to the US also had personal reasons: “I’m getting married, and my fiancé is a professor at Cornell.” Compared to Zurich, the university’s town is small but also pretty, with many nearby finger lakes – an ideal place for family life. “Working at ETH has given me a great opportunity to build relationships and work with people from different parts of Europe,” Yang says. “I want to continue these collaborations in the future.”
...
Engquist, B, Ren, K, Yang, Y. The quadratic Wasserstein metric for inverse data matching. Inverse Problems 36 (2020) 055001. DOI: https://doi.org/10.1088/1361-6420/ab7e04

Yang, Y, Engquist, B, Sun, J, Hamfeldt B F. Application of optimal transport and the quadratic Wasserstein metric to full-waveform inversion. Geophysics 83 (2018) 1. DOI: https://doi.org/10.1190/geo2016-0663.1

Engquist, B, Froese, B D, Yang, Y. Optimal transport for seismic full waveform inversion. Communications in Mathematical Sciences 14 (2016) 8 DOI: https://dx.doi.org/10.4310/CMS.2016.v14.n8.a9
