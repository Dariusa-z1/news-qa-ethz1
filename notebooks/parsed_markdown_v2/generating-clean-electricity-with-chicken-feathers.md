# generating-clean-electricity-with-chicken-feathers.html
...
- Researchers have recently developed a method to repurpose this industrial waste.

- They use the keratin found in chicken feathers to create an environmentally friendly and cost-effective membrane for fuel cells.

## Making good use of industrial waste

The food industry generates enormous amounts of waste and by-products, including from poultry production. Each year, some 40 million tonnes of chicken feathers are incinerated. This not only releases large amounts of CO 2 , but also produces toxic gases such as sulphur dioxide.
...
“I’ve devoted a number of years to researching different ways we can use food waste for renewable energy systems,” says Raffaele Mezzenga, Professor of Food and Soft Materials at ETH Zurich. “Our latest development closes a cycle: we’re taking a substance that releases CO 2 and toxic gases when burned and used it in a different setting: with our new technology it not only replaces toxic substances, but also prevents the release of CO 2 , decreasing the overall carbon footprint cycle”, Mezzenga says.
