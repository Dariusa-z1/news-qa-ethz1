# die-intelligente-kamera-denkt-mit.html
...
Die Seervision-Gründer (v.l.): Reto Hofmann (CTO), Nikos Kariotoglou (CEO) und Conrad von Grebel (CMO). (Bild: Seervision)
...
Der Prototyp für die Vorlesungsaufzeichnungen. (Bild: Seervision)
