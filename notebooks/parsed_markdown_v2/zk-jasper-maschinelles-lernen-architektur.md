# zk-jasper-maschinelles-lernen-architektur.html
...
Stellen Sie sich jedoch vor, man könnte die verfügbaren Daten nutzen, um Rückschlüsse darauf zu ziehen, ob sich eine Wohnung gemütlich oder beengt anfühlt, ob Räume geräumig oder kalt erscheinen. Genau diese Aufgabe steht im Zentrum der Arbeit des ETH-Spin-offs Archilyse. Archilyse sammelt nicht mehr Daten als seine Konkurrenten. Es versucht nur diese intelligenter zu nutzen und zu verbinden, damit Bauunternehmer und Architekten den Wert einer Immobilie besser einschätzen können. Anhand von Grundrissen und urbanen Kontextdaten versucht das Unternehmen, die subjektiven Qualitäten eines Raumes abzuleiten. So kann Archilyse zum Beispiel sichtbar machen, wo in einer Wohnung mit wie viel Lärm zu rechnen ist.

## Zum Autor

Wenn die Gewinnmaximierung nicht mehr als Raummaximierung sondern als Maximierung der Raumqualität verstanden wird, könnte die technologische Entwicklung plötzlich einen ganz anderen Charakter bekommen. Mit Hilfe von maschinellem Lernen könnten Tools entwickelt werden, mit denen sich Vorhersagen über die Qualität des Raumes machen lassen. Wenn Deckenhöhen nachweislich von Bedeutung sind, wenn eine sorgfältige Modulation des Raumes gezeigt werden kann, wenn natürliches Licht Geld einbringt, werden Bauunternehmer darauf achten. Solche Werkzeuge würden die Metriken ändern, welche die Architektur einschränken, sie würden talentierte Architektinnen und Architekten befähigen, zusätzliche Argument für intelligente Entwürfe zu finden. Aber es liegt an den Fachleuten selber, diese Werkzeuge auch einzusetzen.
