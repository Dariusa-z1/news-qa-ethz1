# support-for-diagnostics-researcher.html
...
The components of Habegger's diagnostics platform: microfluidic components (in a cell culture dish) and an analysis membrane (grey). (Photograph: ETH Zurich / Peter Rüegg)
