...
Fattinger invented the principle and developed its theoretical foundations. Five years ago, he took a sabbatical in the group led by Vörös; the practical implementation of molography has now emerged from that collaboration between the Roche scientists and ETH Zurich.
...
“We expect that this technology will enable more laboratory tests to be performed directly in the doctors’ office in the future rather than in a specialist laboratory. And in the distant future, patients may even be able to use the technology at home,” says Vörös.

Several molograms are arranged on a small chip. In the current design, 40 molograms measure the same molecule, but in future it may be possible to measure 40 or more different markers simultaneously on a chip.
...
Intense focus on market readiness
...
Gatterdam V, Frutiger A, Stengele KP, Heindl D, Lübbers T, Vörös J, Fattinger C: Focal Molography: A new method for the in-situ analysis of molecular interactions in biological samples. Nature Nanotechnology, 25 September 2017, doi: 10.1038/nnano.2017.168
