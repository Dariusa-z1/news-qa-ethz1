# covid-19-research-drugs-vaccines.html
...
The participating researchers have adopted a range of approaches and methods in their projects, but all pursue the same overriding objective: to identify new active substances and vaccines that can mitigate the disease’s progression or even prevent an infection.
...
One example is the virus’s RNA polymerase: this enzyme copies the viral genome, which is present in the form of RNA. ETH toxicologist Shana Sturla wants to block this copying machine, a task on which she is collaborating with Gisbert Schneider , an expert in computer-assisted drug design. In addition to their respective laboratories, the two professors also want to use “Nexus”, the ETH platform for health technology, to test whether known drugs and new drug candidates are effective against the viral RNA polymerase.
