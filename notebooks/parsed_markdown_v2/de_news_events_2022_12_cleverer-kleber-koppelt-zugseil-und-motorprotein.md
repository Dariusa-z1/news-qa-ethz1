# de_news_events_2022_12_cleverer-kleber-koppelt-zugseil-und-motorprotein.html
...
Nirgendwo ist dieses Prinzip besser umgesetzt als in einer Zelle: Vielen biologischen Prozessen liegen Wechselwirkungen zwischen beweglichen, miteinander gekoppelten Strukturen zugrunde. Doch wie die Natur solche Kopplungen bewerkstelligt, stellte Wissenschaftler:innen lange vor ein Rätsel.

Nun haben Forschende der ETH Zürich und des Paul Scherrer Instituts (PSI) eine Kopplung, die für die Zellteilung von Hefen notwendig ist, untersucht. Sie haben herausgefunden, dass die Kopplung durch die Kondensation von Proteinen zu einem Flüssigkeitströpfchen zustande kommt.

Dadurch erreichen die Proteine die perfekten Materialeigenschaften, welche die biologische Funktion gewährleisten. Die Ergebnisse wurden soeben in der Fachzeitschrift Nature Cell Biology veröffentlicht.
...
Um diese aussergewöhnliche Kopplung zwischen Mikrotubulus und Aktinfaden zu erreichen, sitzen an der Spitze des Mikrotubulus drei Proteine, die den Kern des sogenannten Kar9-Netzwerks bilden.
...
Barral ist fasziniert wie ausgeklügelt dieser Leim ist. «Es ist nicht einfach irgendein Klebstoff, sondern er ist smart und kann räumliche Informationen einbeziehen, um sich gezielt an der richtigen Stelle zu bilden.»

Im Gewirr identischer Mikrotubuli des Zytoplasmas empfängt nur ein einziges der Röhrchen das Leimtröpfchen, dass es ihm ermöglicht, sich an den Aktinfaden anzuhängen und den Zellkern (und damit die genetische Information) an den richtigen Ort zu ziehen. «Wie die Natur es schafft, eine komplexe Struktur am Ende eines einzigen Mikrotubulus zusammenzufügen und nicht an anderen, ist wirklich erstaunlich», sagt er.

Die Forscher glauben, dass die Flüssigkeitseigenschaften der Proteine diese aussergewöhnliche Spezifität erreichen. So wie Öltröpfchen in einer Vinaigrette miteinander verschmelzen, könnten sich auf vielen Mikrotubuli zunächst kleine Tröpfchen bilden, die dann zu einem grösseren Tröpfchen auf einem einzigen Mikrotubulus zusammenwachsen. Wie dies genau ablaufen könnte, ist noch unbekannt und Gegenstand weiterer Untersuchungen in den Labors von Steinmetz und Barral.
