# mystery-of-the-martian-resolved.html
...
- The new observations show that the radius of the Martian core has decreased from the initially determined range of 1,800–1,850 kilometres to somewhere in the range of 1,650– 1,700 kilometres.
...
To infer the composition of a material from such profiles, researchers usually compare the data with that of synthetic iron alloys containing different proportions of light elements (S, C, O, and H). In the lab, these alloys are exposed to high temperatures and pressures equivalent to those found in the interior of planets to then measure density and seismic wave speed. However, most of these experiments refer to the Earth’s interior and are hardly applicable to Mars. That’s why the ETH team used quantum-mechanical calculations on “Piz Daint” to identify the properties of a variety of alloys. However, as the researchers compared the calculated profiles with the seismic data, they encountered a problem. It turned out that no material matched the values at both the interior and outer rim of the Martian core. For example, at the core-mantle boundary, the matching iron alloy would have needed to contain much more carbon than in the core’s interior. “That made us realise that the region we had previously considered to be the outer rim of the liquid iron core was not the core after all, but actually the innermost part of the mantle,” explains Huang. In support of this, the researchers found that the profiles measured and computed in the outermost 150 kilometres of the core were, in fact, consistent with those of molten silicates — the same material that, in solid form, makes up the Martian mantle. Further analysis of earlier marsquakes and additional simulations confirmed this result. Regrettably however, the dusty solar panels and the resulting lack of power made it impossible for the InSight lander to provide additional data that could have shed more light on the composition and structure of Mars’s interior, as Khan recounts. “Yet, InSight was a very successful mission that provided us with a lot of new data and insights that will be analysed for years to come.”
