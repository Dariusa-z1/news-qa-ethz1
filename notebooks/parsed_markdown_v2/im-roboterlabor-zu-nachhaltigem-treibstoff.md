# im-roboterlabor-zu-nachhaltigem-treibstoff.html
...
- Als erstes Demonstrationsprojekt suchten die Forschenden nach besseren Katalysatoren zur Herstellung von Methanol.
...
Das grosse Problem bei der Suche nach optimalen Katalysatoren für die Herstellung von Methanol: Theoretisch gibt es praktisch unendlich viele Möglichkeiten, Atome zu einem Katalysator zu verbinden. «Der chemische Raum, in dem wir nach Katalysatoren suchen, umfasst etwa 10 20 Möglichkeiten (hundert Milliarden Milliarden). Wir müssen also buchstäblich die Nadel im chemischen Heuhaufen finden», erklärt Christophe Copéret, Professor am Laboratorium für Anorganische Chemie der ETH Zürich und Mitinitiator des Swiss-Cat+-Projekts.
...
In einer ersten Runde hat der Algorithmus anhand der zur Einschränkung der Komplexität getroffenen Vorgaben 24 Katalysatorzusammensetzungen zufällig ausgewählt. Diese wurden direkt in der automatisierten Laborinfrastruktur von Swiss Cat+ hergestellt und anschliessend getestet.

## Schnell viele Resultate mit hoher Verlässlichkeit

Die Ergebnisse dieser ersten Auswahl dienten den Forschenden als Ausgangspunkt für eine KI-Prognose. Und auch deren vorhergesagten Zusammensetzungen wurden wieder automatisch synthetisiert und getestet. Insgesamt sechs derartige Runden haben die Wissenschaftler:innen ihr integriertes System in diesem ersten Demonstrationsversuch absolvieren lassen.

Dass sich die Ergebnisse zwischen den Runden nicht linear, sondern sprunghaft verbesserten, war durchaus beabsichtigt. Der Algorithmus beinhaltet nämlich neben der Optimierung der Ergebnisse der Vorrunden auch eine erkundende Komponente, über die in jeder Runde völlig neue Versionen von Zusammensetzungen eingespeist wurden. So verhinderten die Forschenden, dass die Berechnungen in einer engen Optimierungssackgasse des grossen Möglichkeitsraums stecken blieben.

Für die Forschenden ging es in diesem ersten Projekt allerdings weniger darum, bereits den bestmöglichen Katalysator für die Methanolsynthese zu finden. «Das Wissen über Katalysatoren zur Herstellung von Brennstoffen beruht heute noch grösstenteils auf dem Knowhow aus der Erdölindustrie», sagt ETH-Professor Copéret. «Verlässliche Daten zu den Reaktionen der nachhaltigen Energiewirtschaft fehlen noch weitgehend.» Sie sind aber nötig, damit KI-Algorithmen und menschliche Forscherintelligenz im riesigen Raum der chemischen Möglichkeiten gezielter suchen können. «Genau diese qualitativ hochstehenden und reproduzierbaren Daten liefert jetzt unser KI-gestütztes Roboterlabor. Sie werden die ganze Katalysatorforschung ein gutes Stück voranbringen», ergänzt Laveille.

«Mit dem Swiss-Cat+-Hub steht uns eine komplexe Forschungsinfrastruktur zur Verfügung, die wir mit den Gruppen in unseren Instituten nicht selbst betreiben könnten», erklärt Professor Christophe Copéret vom Departement für Chemie und angewandte Biowissenschaften der ETH Zürich. Die Forschung an den Hochschulen ist nämlich stark von Doktorierenden abhängig, die nur für wenige Jahre bleiben. Mit jedem Weggang eines Doktoranden geht ein Grossteil des von ihm aufgebauten Knowhows verloren. Swiss Cat+ hingegen ist eine Technologieplattform, die mit festangestellten Experten:innen arbeiten soll, welche das Knowhow laufend ausbauen und die Infrastruktur mit den neuesten Technologien weiterentwickeln können.

Der 2019 von Copéret und von Nicolai Kramer, Professor an der EPFL, initiierte Swiss-Cat+-Hub stellt heute an zwei Standorten in Zürich und Lausanne Forschenden aus Hochschulen und Industrie hochmoderne Infrastrukturen zur Verfügung. Diese ermöglichen es, Katalysatoren mit Hilfe von KI-Datenanalyse-Werkzeugen zu entwerfen und in automatisierten Hochdurchsatz-Labors auch gleich herzustellen sowie deren Wirksamkeit zu überprüfen. Inzwischen nutzen bereits Dutzende von ETH-Projekten die beiden Plattformen.

Ramirez A, Lam E, Pacheco Gutierrez D, Hou Y, Tribukait H, Roch LM, Copéret C, Laveille P: Accelerated Exploration of Heterogenous CO2 Hydrogenation Catalyts by Bayesian-optimized High-throughput and Automated Experimentation. Chem Catalysis, 18. Januar 2024, doi: externe Seite 10.1016/j.checat.2023.100888

Laveille P, Miéville P, Chatterjee S, Clerc E, Cousty JC, de Nanteuil F, Lam E, Mariano E, Ramirez A, Randrianarisoa U, Villat K, Copéret C, Cramer N: Swiss Cat+, a Data-driven Infrastructure for Accelerated Catalysts Discovery and Optimization. Chimia 2023, 77: 154, doi: externe Seite 10.2533/chimia.2023.154
