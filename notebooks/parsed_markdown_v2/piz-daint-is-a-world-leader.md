# piz-daint-is-a-world-leader.html
...
In data science, which has an increasingly important role and is one of ETH Zurich’s main focus areas, supercomputers enable the analysis of enormous amounts of data. This is an area in which Piz Daint is particularly strong: it is able to analyse the resulting data while the calculations are still ongoing.
