# the-executive-board-reports-4.html
...
From 1 July 2019, postdocs throughout ETH will be subject to the same employment conditions. This defines a standard 100% workload for postdocs at ETH. Part-time arrangements can only be approved for family reasons or in the case of work for another employer. A three-tier salary model is currently undergoing internal consultation proceedings. The lowest tier begins with the minimum rate of the Swiss National Science Foundation (SNSF) of CHF 80,000 in the first year of employment. This if followed by annual increases within the tier to a maximum rate of CHF 95,600. The intermediate salary tier ranges from CHF 86,800 per year to CHF 100,000 after four years. The third salary tier covers a range of CHF 91,150 to the SNSF maximum of CHF 105,000. The consultation proceedings among departments, the University Assembly and all affected university groups will continue until 21 December 2018.
