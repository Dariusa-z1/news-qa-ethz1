# imaging-the-brain-with-ultrasound-waves.html
...
With the help of sophisticated algorithms and high-performance computers such as "Piz Daint" at CSCS, researchers like ETH Zurich’s Andreas Fichtner, professor at the Institute of Geophysics and head of the Seismology and Wave Physics Group, can use this wave data to characterise the three-dimensional structure of the Earth. The parallels to propagation between ultrasound and earthquake waves, as well as the team's know-how in the field of wave physics—how the information that waves carry can be used and converted into images—led the ETH professor and his group to also study wave propagation for medical ultrasound.
...
With this method, they obtain a quantitative image instead of the less informative greyscale image common to conventional ultrasound. By using all the information from the complete wave field, the researchers can correctly map the physical properties of the medium—the speed at which ultrasound waves propagate through the tissue, their damping properties, and the density of the tissue—at every point in the brain. This ultimately makes it possible to determine the tissue type and distinguish whether it is a brain mass or tumor tissue, for example, since the density, attenuation, or speed of sound associated with the different types of tissues are known from laboratory experiments.
