# wie-die-eth-zuerich-mit-dem-wachstum-der-studierendenzahlen-umgehen-will.html
...
Wäre ein Numerus Clausus dafür nicht das einfachste und effektivste Mittel? Ein Numerus Clausus ist für die ETH Zürich aktuell kein Thema, denn das ist ein sehr pauschales und starres Werkzeug. Das widerspricht schon nur der grossen Nachfrage nach Fachkräften, etwa in der Informatik oder im Gesundheitsbereich. Darauf muss die Zulassung Rücksicht nehmen können. Zudem ist die Situation nicht überall gleich: In manchen Departementen und Studiengängen laufen wir hinsichtlich Betreuung hart am Limit, in anderen nicht. Wir müssen also definieren, was wir mit den vorhandenen Ressourcen leisten können.

… das heisst aber doch, dass wir Limiten definieren müssen pro Fach? Ja, wir werden Kapazitätsgrenze definieren müssen.

Wie unterscheiden sich Kapazitätsgrenzen von einem Numerus Clausus? Eine Kapazitätsgrenze ist kein Automatismus und löst keinen direkten Aufnahmestopp aus. Kapazitätsgrenzen sollen von den Departementen spezifisch pro Studiengang definiert und regelmässig aktualisiert werden. Sie wirken als Schwelle, ab welcher gewisse Steuerungsmassnahmen zum Einsatz kommen.

Welche Steuerungsmassnahmen sind das? Da sprechen wir tatsächlich über eine strengere Selektion von ausländischen Studierenden auf Masterstufe. Das ist aber nichts Neues: Wir selektieren in diesem Bereich schon heute nach Leistung. Künftig werden wir das in manchen Fächern noch systematischer tun müssen.

Wie meinen Sie das? Eine grosse Herausforderung ist es aktuell, die Leistungen der ausländischen Studierenden an ihren Herkunftsuniversitäten zu beurteilen und zu vergleichen. Die Notenskalen und Bewertungssysteme sind sehr unterschiedlich. Manche Departemente verwenden bereits ein Statistik-Tool, welches anhand der Daten aller bisherigen Bewerber einer bestimmten Uni ermittelt, in welcher Leistungsperzentile sich eine Bewerberin oder ein Bewerber an der Herkunftsuni befindet. Künftig soll dieses Tool an der ganzen ETH angewendet werden. Dadurch können wir evidenzbasiert selektieren.
...
Das heisst, die ETH muss mit dem Wachstum leben? Wir können das Wachstum als ETH einfach nur beschränkt beeinflussen. Und selbst wenn wir strenger selektieren, wird sich das Wachstum noch verstärken. Ich bin aber überzeugt, dass wir Dinge vereinfachen und dadurch den Aufwand für die Lehrenden und die Administration verringern können. Gerade hat ein Projekt begonnen, mit dem wir das Prüfungswesen vereinfachen und im akademischen Kalender mehr Freiräume öffnen wollen. Eine weitere Massnahme ist die Stärkung von computerbasierten Prüfungen, welche z.B. zur Entlastung von Assistierenden beitragen soll. Ein Beispiel für eine kurzfristige Entlastung wäre, Service-Lehrveranstaltungen besser auf die Departemente zu verteilen, also jene Kurse, die ein Departement für Studierende anderer Departemente anbietet.

Zielt die Strategie nur auf das Masterstudium? Nein, wir diskutieren auch beim Bachelor über mögliche neue Zulassungsmassnahmen. Wir beobachten, dass auch dort die Anzahl Bewerbungen rasch ansteigt, wenn auch nicht ganz so schnell wie beim Master. Eine Möglichkeit wäre, bei ausländischen Bewerbenden eine Mindestabschlussnote der Maturität zu verlangen.
