# predicting-earthquakes-and-tsunamis-with-fibre-optic-networks.html
...
- The active noise suppression data only needs to be stored and analysed. This requires neither additional equipment nor expensive infrastructure.

- This cost-effective method makes it possible to accurately measure earthquakes even on the ocean floor or in less developed countries.

## Secondary use of noise suppression data

For wealthy countries like Switzerland, having a dense network of earthquake monitoring stations is a matter of course [AF1] . This is not the case in less developed countries and on the floor of the world’s oceans. While poorer regions lack the money for the necessary number of sensors, the oceans require complex systems that can reliably measure minimal pressure changes at depths of thousands of metres and bring the data signals to the surface.
