# umnutzung-vom-ehemaligen-munitionslager-zum-eth-lager.html
...
Fabian Fröhlich and his team were tasked with making the rooms in the second part of the building usable. "After an initial on-site inspection and a short planning phase, we then set up over 300 pallet spaces up there," reports Fröhlich. Storage racks were installed and systematically labelled. This means that each item has a traceable storage location. For the core drillings, which are over two metres long, and large machines that do not fit into the racks, appropriate floor storage spaces were created.

## Automated and centrally managed

Once Fröhlich and his team had set up the second room according to the researchers' needs, the storage and retrieval still had to be coordinated. Together, they developed a new process that allows the department's employees to simply register storage orders, including the necessary transport, using an online form. "The new solution simplifies our work and we always know where our items are stored when we need them," explains Madonna.

The Campus Services warehouse team manages over 5000 m 2 of storage space at various locations in Switzerland. All relevant information on the use of this space by ETH units is available in the Logistics Help Centre .

Campus Services We support you with a range of specific services related to working at ETH. Find out how we can simplify your everyday life. → Our services
