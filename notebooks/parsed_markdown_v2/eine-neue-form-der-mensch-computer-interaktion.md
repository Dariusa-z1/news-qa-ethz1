# eine-neue-form-der-mensch-computer-interaktion.html

**Source:** de_news_events/2023/04/eine-neue-form-der-mensch-computer-interaktion.html

## Das Wichtigste in Kürze

- ETH-Forscher haben eine neue Programmiersprache namens LMQL (Language Model Query Language) entwickelt.

- Durch die Kombination von natürlicher Sprache und Programmiersprache können gezieltere Anfragen an grosse Sprachmodelle, wie ChatGPT, gestellt werden.

- Die neue Programmiersprache ermöglicht es, den Nutzenden Sicherheitseinschränkungen zu formulieren, um unerwünschte Ergebnisse möglichst zu vermeiden.
...
Interessierte, die mehr über LMQL erfahren und die Programmiersprache selbst testen möchten, können auf der entsprechenden Website auf eine externe Seite Testversion zugreifen. Diese kann direkt im Webbrowser ausgeführt werden.

Weitere Informationen: externe Seite http://lmql.ai

Luca Beurer-Kellner und Marc Fischer sind Doktoranden am Departement für Informatik. Martin Vechev ist Professor für Computerwissenschaften.

Die drei ETH-Forschenden entwickelten die Programmiersprache LMQL gemeinsam.
